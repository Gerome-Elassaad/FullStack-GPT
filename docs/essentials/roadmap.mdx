---
title: "Roadmap"
description: "See whats coming to Repo-Booster in the future"
icon: "road"
---

Repo-Booster is currently in beta, and we're excited to share what we have in store! This roadmap provides an overview of the features we're currently working on, as well as the ones we've already completed.
...
<Card title="Features in Development">
  ...
  GitHub](https://github.com/orgs/Repo-Booster/projects/3).
</Card>
...
<CardGroup cols={1}>
  ...
  <Card title="Dynamic translations for multiple languages">
    We strive to make Repo-Booster accessible to everyone. We're always looking to
  ...
  <Card title="Documentation overhaul">
    ...
    familiarize themselves with Repo-Booster.
  </Card>
...
<Card>
  ...
  greatly appreciate the community's support in developing Repo-Booster. If you're
