---
title: "Workflows"
description: The workflow automation system within Repo-Booster.
icon: "wave-sine"
---

A core function of Repo-Booster is AI powered workflow automation. This documentation covers key concepts within our workflow platform.
...
- open platform/Repo-Booster_platform/schemas/workflow/blocks
...
- open platform/Repo-Booster_platform/web/api/workflow/blocks/web/__init__.py
    - import your block
