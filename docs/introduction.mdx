---
title: Introduction
description: "Welcome to Repo-Booster"
---

Repo-Booster is an autonomous AI Agent platform that empowers users to create
...
Repo-Booster achieves goals by chaining calls to large language models such as GPT-4 and is designed to understand
...
<CardGroup cols={2}>
  <Card title="How It Works" icon="chart-mixed" href="/essentials/usecases">
    Understand how Repo-Booster achieves goals by chaining language models.
  </Card>
...
<CardGroup cols={2}>
  <Card
    title="Repo-Booster Website"
    icon="browser"
    href="https://Repo-Booster.reworkd.ai/"
  >
    Explore our official website.
  </Card>
  <Card title="Github" icon="github" href="https://github.com/reworkd/Repo-Booster">
...
The entire Repo-Booster team is incredibly excited for the road to follow. We have a ton of exciting features planned for the future, and we hope you'll join us on this journey.
